   ...
   <article className="card-article">
      <div className="card-container">
        <article className={`header-card bg-${pokemon?.types[0].type.name}`}>
          <img className="header-image" src={pokemon?.sprites.other["official-artwork"].front_default} alt=""/>
        </article>
        ...
        <h2 className="header-name">{pokemon?.name}</h2>
          <ul className="card-weight-height">
              <li className="weight-height"><span className="weight-height-span">weight</span> {pokemon?.weight}</li>
              <li className="weight-height"><span className="weight-height-span">height</span> {pokemon?.height}</li>
          </ul>
        </div>
        <hr className="hr"/>
        ...
        <ul className="body-card">
          <li className="type-ability">
            ...
            <div className={`type-ability-fill bg-${pokemon?.types[0].type.name}`}>
              <div className="type-ability-result"> {pokemon?.types[0].type.name}</div></div></li>

          <li className="type-ability">
              <span className="type-span">Abilitys</span>
              <div className="type-ability-fill">
                <div className="type-result-ability">{pokemon?.abilities[0].ability.name}</div>
                <div className="type-result-ability">{pokemon?.abilities[1].ability.name}</div>
              </div>
            </li>
        </ul>
      ...
      <section className="stats-container">
        ...
        <article className="stats-info">
          <li className="stats-info">
              <header className="stats-header">
                ...
                <span className="stats-value">{pokemon?.stats[0].base_stat}/255</span>
              </header>

              <div className="progress-bar-container">

                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`} style={{width:`${hp}%`}}>
        ...
        <li className="stats-info">
          ...
          <div className="progress-bar-container">
                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`}  style={{width:`${attack}%`}}>
                </div>
              </div>
        </li>
        ...
        <li className="stats-info">
          ...
          <div className="progress-bar-container">
                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`} style={{width:`${defense}%`}}>
                </div>
              </div>
        </li>
        ...
        <li className="stats-info">
          ...
          <div className="progress-bar-container">
                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`} style={{width:`${specialAttack}%`}}>
                </div>
              </div>
        </li>
        ...
        <li className="stats-info">
          ...
          <div className="progress-bar-container">
                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`} style={{width:`${specialDefense}%`}}>
                </div>
              </div>
        </li>
        ...
        <li className="stats-info">
          ...
          <div className="progress-bar-container">
                <div className={`progress-stat bg-${pokemon?.types[0].type.name}`} style={{width:`${speed}%`}}>
                </div>
              </div>
        </li>
      ...
      <footer className="movements">
        ...
        <div className="movements-container">
        {
          pokemon?.moves.map(tagInfo => (
            <li className="movements-tags" key={tagInfo.moves}>{tagInfo.move.name}</li>
            ))
          }
        </div>
      </footer>
